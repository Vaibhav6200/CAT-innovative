...
let transformBallAndStick = new ChemDoodle.TransformCanvas3D("3dMolecule", 700, 600, true);
...
function refresh(){
    var div = document.getElementById('selectButton');
...
sketcher.checksOnAction = function(force){
    ...
    let transform = new ChemDoodle.TransformCanvas3D("3dSketcher", 500, 500);
    transform.styles.set3DRepresentation('Ball and Stick');
    transform.styles.backgroundColor = 'transparent';
    transform.styles.atoms_displayLabels_3D = true;
