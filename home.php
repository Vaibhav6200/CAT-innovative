...
<body onload="homeDisplay()">
    ...
    <div class="reference d-none">
        <div class="container">
            <p>
                <h2 style="color:#A8A8A8">REFERENCES:</h2>
                <b >Books:</b><br><br>

                <ul >
                    <li>K. Veera Reddy, "Symmetry and Spectroscopy of Molecules", New Age International (P) Limited, Publishers (1997).</li>
                    <li>M.S.Gopinathan & V. Ramakrishnan, "Group Theory In Chemistry", Visal Publications (2000).</li>
                    <li>F. A. Cotton, "Chemical Applications of Group Theory, Wiley-Interscience, New York (1963).</li>
                </ul><br><br>
                <b >Webliography:</b><br><br>
                <a href="http://en.wikipedia.org/wiki/Molecular_symmetry" >http://en.wikipedia.org/wiki/Molecular_symmetry</a>
            </p>
        </div>
    </div>
